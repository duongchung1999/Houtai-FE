...
// import FormItemGroup from '@/components/formGenerator/FormItemGroup/FormItemGroup.vue'
    ...
    return (
      <el-col span={config.span} class={className}
        ...
        <el-form-item label-width={labelWidth} label={config.showLabel ? config.label : ''} required={config.required}>
          <render key={config.renderKey} conf={currentItem} onInput={event => { this.$set(config, 'defaultValue', event) }}>
            {child}
          </render>
        </el-form-item>
